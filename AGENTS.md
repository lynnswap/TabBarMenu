...
- CI discovers every installed, available iOS 18.x, 26.x, and 27.x runtime and creates a test job for each runtime identifier. New minor and patch runtimes are included automatically when added to the runner image.
